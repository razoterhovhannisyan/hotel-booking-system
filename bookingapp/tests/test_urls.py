...
class TestUrls(TestCase):
    ...
    def test_roomfilter_url(self):
        ...
        self.assertEquals(resolve(url).func.view_class, views.RoomFilterSortView)


    def test_availabilityrooms_url(self):
        url = reverse('availability-rooms')
        self.assertEquals(resolve(url).func.view_class, views.RoomAvailabilityView)


    def test_cancelbook_url(self):
        url = reverse('cancel-book', args = [1])
        self.assertEquals(resolve(url).func.view_class, views.CancelBookingView)
